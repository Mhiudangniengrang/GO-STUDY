...
const LandingPageUser = ({ children }) => {
  ...
  return (
    <Layout className="landing-page min-h-screen bg-white">
      <Header className="sticky top-0 z-50 bg-gradient-to-t from-[#D7DDFF] to-white p-12 shadow-md flex justify-between items-center rounded-b-3xl mb-4 transition duration-500 ease-in-out transform hover:scale-105">
        <Link to="/user">
